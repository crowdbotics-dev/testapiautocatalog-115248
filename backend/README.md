...
## Project Structure
    ...
    ├── testapiautocatalog_115248  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115248`
...
2. Clone this repo and `cd testapiautocatalog_115248`
